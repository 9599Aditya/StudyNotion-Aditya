...
function Catalog() {
  ...
  useEffect(() => {
    (async () => {
      try {
        ...
        )?._id; // Using find instead of filter and getting the first item directly
        if (category_id) {
  ...
  const { selectedCategory, differentCategory, mostSellingCourses } = catalogPageData.data || {}; // Destructuring with default empty object
